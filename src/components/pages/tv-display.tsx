                                        ...
                                        return (
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    backgroundColor: isBooked ? "black" : isLocked ? "grey" : seatData ? seatData.color : "white",
                                                    border: "1px solid white",
                                                    boxSizing: "border-box",
                                                    fontSize: 10,
                                                    display: "flex",
                                            ...
                                            >
                                                <div className="flex flex-col justify-center items-center text-center">
                                                    <p className="text-[15px] font-bold text-black" style={{ color: isBooked ? 'white' : 'black' }}>{isBooked ? 'Booked' : isLocked ? 'Locked' : seatData?.name}</p>
                                                    <p className="text-[10px] text-black" style={{ color: isBooked ? 'white' : 'black' }}>{seatData?.category}</p>
                                                </div>
                                            </div>
                                        );
                                    })
